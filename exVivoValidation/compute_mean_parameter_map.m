...
parameter_folder = '/project/3015069.01/derived/BrainSample-2/ses-03/gre_renaud/concatenate_signals/parameter_maps/noise4/';
...
parameter_map_example = load_nii_img_only('/project/3015069.01/derived/BrainSample-2/ses-03/gre_renaud/concatenate_signals/parameter_maps/noise4/fa-05/BrainSample-2_ses-03_FVF_fa-05_20_directions_polyfit_cartesian_with_theta_noise4.nii.gz');
...
for k = 1:length(parameter_list)
    ...
    for l = 1:length(fa_list)
        ...
        parameter_map_nii = load_untouch_nii([fa_folder 'BrainSample-2_ses-03_' parameter '_fa-' fa '_20_directions_polyfit_cartesian_with_theta_noise4.nii.gz']);
    ...
    save_untouch_nii(parameter_map_nii, [mean_folder 'BrainSample-2_ses-03_' parameter '_mean_20_directions_polyfit_cartesian_with_theta_mask_noise4.nii.gz']);
    parameter_map_nii.img = parameter_map_std;
    save_untouch_nii(parameter_map_nii, [std_folder 'BrainSample-2_ses-03_' parameter '_std_20_directions_polyfit_cartesian_with_theta_mask_noise4.nii.gz']);
end
