...
data_path = [data_folder 'BrainSample-2_ses-03_all_orientations_fa-20_concatenate_signal_cartesian_polyfit_2_orientation-4.nii.gz'];
...
tic()
dict_log_name = 'SignalWithNoise0_1rep_9orientations_BrainSample2_fix_xa_log_scale_cartesian_polyfit.h5py';
...
%     end
    ...
    for nb = 1:nb_map
        ...
        title({['log, FVF : ' num2str(FVF_log_CSF(k, nb)) ' g ratio : ' num2str(gRatio_log_CSF(k, nb)) ...
...
%     end
    ...
    for nb = 1:nb_map
        ...
        plot(best_dict_log_match, 'r')
        title({['log, FVF : ' num2str(FVF_log_CC(k, nb)) ' g ratio : ' num2str(gRatio_log_CC(k, nb)) ...
