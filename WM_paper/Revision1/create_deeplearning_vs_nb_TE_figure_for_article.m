...
hold on
for l = 1:length(noise_list)
    plot(nb_TE_list, total_min_loss(:, l), 'x--', 'Color', colors(l, :), 'LineWidth', 4, 'MarkerSize', 20);
    h(l) = plot(nb_TE_list, total_min_val_loss(:, l), 'x-', 'Color', colors(l, :), 'LineWidth', 4, 'MarkerSize', 20);
end
