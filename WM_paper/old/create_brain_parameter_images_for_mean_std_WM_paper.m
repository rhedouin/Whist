...
for k = 1:length(parameter_list)
    ...
    parameter_map.(parameter) = load_nii_img_only([flip_angle_folder 'BrainSample-2_ses-03_' parameter '_' fa '_20_directions_polyfit_cartesian_with_theta_noise4.nii.gz']);
...
%     keyboard;
    ...
    parameter_map_permute.(parameter) = permute(parameter_map.(parameter), [2 3 1]);
    parameter_map_permute.(parameter) = parameter_map_permute.(parameter)(end:-1:1, :, :);
end
