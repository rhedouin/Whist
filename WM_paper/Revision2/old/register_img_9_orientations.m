...
% other{end+1} = 'BrainSample-2_ses-03_mp2rage_orientation-4_t1_brain_2_BrainSample-2_ses-03_gre_orientation-4_fa-20_magn_echo-1_brain_without_external_csf';
% other{end+1} = 'BrainSample-2_ses-03_gre_orientation-4_fa-20_magn_echo-1_without_external_csf';
% other{end+1} = '/project/3015069.01/derived/BrainSample-2/ses-03/gre_renaud/masks/BrainSample-2_ses-03_gre_orientation-4_brain_mask_all';
