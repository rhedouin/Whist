                        ...
                        for p = 1:lT2myel
                            ...
                            for q = 1:lT2out
                                ...
                                for r = 1:lWeight
                                    ...
                                    tempSignalVectorOriginalPhase = zeros(lVec,1);   
                                    ...
                                    for rot = 1:nb_orientation
                                        ...
                                        tempSignalVectorOriginalPhase((rot-1)*length_one_orientation + 1 : rot*length_one_orientation) = [theta_noisy norm_magn phase];
                                        
                                    end
                                    main_direction = SignalComponent(l,m,n,o,4).current_dir;
                                    
                                    SignalValues(:,k,l,m,n,o,p,q,r,nb) = tempSignalVectorOriginalPhase;
...
base_name = [prefix_name '_' num2str(nb_replica) 'rep_' vector_type_name '_' num2str(nb_orientation) 'orientations_BrainSample2_fix_xa_original_phase'];
