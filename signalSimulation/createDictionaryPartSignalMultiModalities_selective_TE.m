function out = createDictionaryPartSignalMultiModalities_selective_TE(signal_path, output_folder, T2myelRange, T2outRange, weightRange, nb_TE, noise, FVF, nb_orientations, replic, dict_options)
load(signal_path);
time = time(1:nb_TE);
...
for kCoordinate = 1:lCoordinate
    ...
    base_name = [prefix_name '_FVF' num2str(FVF) '_replic' num2str(replic) '_' num2str(nb_orientations) ...
                 'orientations_' num2str(nb_TE)  'TE_Porcine1_fix_xa_' coordinate '_'  suffix_theta];
