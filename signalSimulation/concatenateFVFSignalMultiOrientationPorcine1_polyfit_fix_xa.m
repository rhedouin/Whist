...
length_one_orientation_complex = 24;
length_one_orientation_complex_theta = 25;
...
SignalValues_cartesian=zeros(lVec_complex, lFVF, lgRatio, lXi, lXa, lDir, lT2myel, lT2out, lWeight, nb_replica,'single');
SignalValues_cartesian_theta=zeros(lVec_complex_theta, lFVF, lgRatio, lXi, lXa, lDir, lT2myel, lT2out, lWeight, nb_replica,'single');
                        ...
                        for p = 1:lT2myel
                            ...
                            for q = 1:lT2out
                                ...
                                for r = 1:lWeight
                                    ...
                                    tempSignalVector_cartesian = zeros(lVec_complex, 1);                                    
                                    tempSignalVector_cartesian_theta = zeros(lVec_complex_theta, 1);                                    
                                    ...
                                    for rot = 1:nb_orientation
                                        ...
                                        real_complex_poly = real(norm_complex_poly);
                                        imag_complex_poly = imag(norm_complex_poly);
         
%                                         tempSignalVector_cartesian((rot-1)*length_one_orientation_complex + 1 : rot*length_one_orientation_complex) = [real_complex_poly imag_complex_poly];
                                        tempSignalVector_cartesian_theta((rot-1)*length_one_orientation_complex_theta + 1 : rot*length_one_orientation_complex_theta) = [theta  real_complex_poly imag_complex_poly];
...
%                                     SignalValues_cartesian(:,k,l,m,n,o,p,q,r,nb) = tempSignalVector_cartesian;
                                    SignalValues(:,k,l,m,n,o,p,q,r,nb) = tempSignalVector_cartesian_theta;
...
% SignalValues_cartesian = squeeze(SignalValues_cartesian);
% SignalValues_cartesian_theta = squeeze(SignalValues_cartesian_theta);
...
base_name = [prefix_name '_' num2str(nb_replica) 'rep_' num2str(nb_orientation) 'orientations_Porcine1_fix_xa_polyfit_cartesian_with_theta'];
signal_name = [base_name '.h5py'];

% SignalValues = SignalValues_cartesian_theta;
save([dico_folder signal_name], 'SignalValues', ...
    'FVFRange', 'gRatioRange', 'xiRange', 'xaRange', 'T2myelRange','T2outRange','weightRange', 'FVFValues', ...
    'gRatioValues', 'xiValues', 'xaValues', 'T2myelValues', 'T2outValues', 'directionsValues', 'thetaValues', ...
    'weightValues', 'nb_replica', 'time', 'infoDico', 'infoSignal', 'sphere_rotations', '-v7.3')
...
% 
% base_name = [prefix_name '_' num2str(nb_replica) 'rep_' num2str(nb_orientation) 'orientations_Porcine1_fix_xa_polyfit_cartesian_without_theta'];
% signal_name = [base_name '.h5py'];
% 
% SignalValues = SignalValues_cartesian;
% 
% save([dico_folder signal_name], 'SignalValues', ...
%     'FVFRange', 'gRatioRange', 'xiRange', 'xaRange', 'T2myelRange','T2outRange','weightRange', 'FVFValues', ...
%     'gRatioValues', 'xiValues', 'xaValues', 'T2myelValues', 'T2outValues', 'directionsValues', 'thetaValues', ...
