...
%                                             if (phase_unwrap(end) ~= phase(end))
%                                                 it = it +1
%                                             end
                                            phase_unwrap = phase;
                    
                                            norm_phase = phase_unwrap(3:end) - phase_unwrap(1) - (phase_unwrap(2)-phase_unwrap(1))*(time(3:end) - time(1))/(time(2) - time(1));
                                        else
                                            norm_phase = [];
                                        end
...
base_name = [prefix_name '_' num2str(nb_replica) 'rep_' vector_type_name '_' num2str(nb_orientation) 'orientations_BrainSample2_fix_xa_log_scale'];
