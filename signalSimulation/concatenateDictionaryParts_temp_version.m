...
suffix = 'polyfit_cartesian_demean_with_theta';
...
% for noise = noise_list
    ...
    for nb_TE = nb_TE_list
        ...
        dict_path = [input_folder 'SignalWithNoise'  noise '_FVF40_replic1_' num2str(nb_orientation) 'orientations_' num2str(nb_TE) 'TE_Porcine1_fix_xa_' suffix '.h5py'];
        ...
        for k = 1 : lFVF
            ...
            for num = 1 : nb_replica
                ...
                dict_path = [input_folder 'SignalWithNoise'  noise '_FVF' num2str(FVF) '_replic' num2str(num) '_'  num2str(nb_orientation) 'orientations_' num2str(nb_TE) 'TE_Porcine1_fix_xa_' suffix '.h5py'];
        ...
        base_name = [prefix_name '_' num2str(nb_replica) 'rep_' num2str(nb_orientation) 'orientations' num2str(nb_TE) '_TE_Porcine1_fix_xa_' suffix];
