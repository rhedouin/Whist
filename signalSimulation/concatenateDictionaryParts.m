...
dico_folder = [base_folder 'dictionaries/multi_orientations/theorically_good_15_rotations/'];
...
dict_path = [input_folder 'SignalWithNoise'  noise '_FVF40_replic1_' num2str(nb_orientation) 'orientations_Porcine1_fix_xa_' suffix '.h5py'];
...
for k = 1 : lFVF
    ...
    for num = 1 : nb_replica
        ...
        dict_path = [input_folder 'SignalWithNoise'  noise '_FVF' num2str(FVF) '_replic' num2str(num) '_'  num2str(nb_orientation) 'orientations_Porcine1_fix_xa_' suffix '.h5py'];
...
base_name = [prefix_name '_' num2str(nb_replica) 'rep_' num2str(nb_orientation) 'orientations_Porcine1_fix_xa_' suffix];
