...
dico_folder = [base_folder 'dictionaries/multi_orientations/Porcine2/lowres/fix_xa_large_FVF_20_directions_30_TE/'];
...
for nb_TE = [5, 10, 15, 20, 25, 30]
    ...
    for k = 1:length(noise_list)
        ...
        base_name = [prefix_name '_' num2str(nb_replica) 'rep_' num2str(nb_orientation) 'orientations_' num2str(nb_TE) 'TE_' experience_name '_' output_suffix];
