...
(1) Create WM models with chosen microstructure parameters using realistic axon shapes. 
...
(2) Simulate the field perturbation and the corresponding multi GRE signal from a WM model.
