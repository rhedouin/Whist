function [tensor_X, phimap] = create2DTensorXFromOneAxonWithLorentzianCorrection(model, model_parameters)
...
for k = 1:size(sub_myelin_x,1)
    ...
    total_X(sub_myelin_x(k),sub_myelin_y(k),:,:) = (2/3) * myelin_Xi + (1 - (cos(model_parameters.theta)).^2) * R * myelin_Xa * inv(R);
